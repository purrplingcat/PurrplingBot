...
* Latest stable version 1.2.0: [Release v1.2.0 'Carmilla'](https://github.com/EllenFawkes/PurrplingBot/releases/tag/1.2.0)
...
```bash
docker pull purrplingcat/purrplingbot:1.2.0 # Latest stable version 1.2.0 'Carmilla'
