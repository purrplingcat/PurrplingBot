...
* Latest stable version 1.2.2: [Release v1.2.2 'Carmilla'](https://github.com/EllenFawkes/PurrplingBot/releases/tag/1.2.2)
...
```bash
docker pull purrplingcat/purrplingbot:1.2.2 # Latest stable version 1.2.2 'Carmilla'
